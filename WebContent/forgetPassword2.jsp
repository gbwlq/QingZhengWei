				...
				<div class="huige_rt_form menu-box">
					<form name="memberreg" id="memberreg" method="post" action="EnRollServlet"
						...
						<div class="huige_rt_dl">
							...
							<br><br><br>
								<dt>
									<em><h2>新密码：</h2></em> <input type="text" name="username" id="username"
										class="infoInput" size="40"
										onblur="">
								</dt><br><br>
								<dt>
									<em><h2>确认新密码：</h2></em> <input type="text" name="username" id="username"
										class="infoInput" size="40"
										onblur="">
								</dt>
							</dl>
