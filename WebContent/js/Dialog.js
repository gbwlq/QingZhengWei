...
(function($) {
	$.extend({
		DialogBox: {
			defaults: {
				<!--title: "西安三宝双喜清真食品3G官网",-->
				name: "D" + new Date().getTime(),
				type: "text",
				<!--content: "<img src='images\ewm.jpg' width='804' height='441' />",-->
				content: "<img src='images\ewm.jpg' width='804' height='441' />",
				width: 804,
				height: 441,
				time: 0
			...
			create: function(op) {
				...
				var ops = $.extend({},
				this.defaults, op);
				this.element = $("<div class='floatBoxBg' id='fb" + ops.name + "'></div><div class='floatBox' id='" + ops.name + "'><div class='title' id='t" + ops.name + "'><h4></h4><span class='closeDialog' id='c" + ops.name + "' title=\"关闭\"></span></div><div class='content'></div></div>");
